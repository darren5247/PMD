...
export const typesenseInstantsearchDesktopAdapter =
  new TypesenseInstantSearchAdapter({
    ...
    additionalSearchParameters: {
      query_by:
        "title,composers,level,era,elements,collections,publisher,moods,styles,themes,holiday,student_ages,student_types,key_signatures",
      sort_by:
        "title(missing_values: last):asc,level(missing_values: last):asc",
      num_typos: 2,
