...
export const CHolidays = ["Christmas", "Easter", "Fourth of July", "Halloween"];
...
export const CStudentAges = ["Adults", "Children", "Teens"];
    ...
    filterOptions: [
      {
        ...
        apiEndpointFilters:
          "&fields[0]=name&populate[elements][fields][1]=id&filters[elements][publishedAt][$null]=false",
      ...
      },
      {
        ...
        apiEndpoint: "levels",
        apiEndpointFilters:
          "&fields[0]=title&populate[elements][fields][1]=id&filters[elements][publishedAt][$null]=false",
    ...
    filterOptions: [
      {
        ...
        apiEndpoint: "eras",
        apiEndpointFilters:
          "&fields[0]=name&populate[composers][fields][1]=id&filters[composers][publishedAt][$null]=false",
    ...
    filterOptions: [
      {
        ...
        apiEndpoint: "eras",
        apiEndpointFilters:
          "&fields[0]=name&populate[publishers][fields][1]=id&filters[publishers][publishedAt][$null]=false",
        apiEndpointPageSize: 8,
        apiTitleOrName: "name",
        apiSort: "name:asc",
        placeholder: "Select an era",
    ...
    filterOptions: [
      {
        ...
        apiEndpoint: "eras",
        apiEndpointFilters:
          "&fields[0]=name&populate[collections][fields][1]=id&filters[collections][publishedAt][$null]=false",
        apiEndpointPageSize: 8,
        apiTitleOrName: "name",
        apiSort: "name:asc",
        placeholder: "Select an era",
...
export const CItemKeys: IItemKey[] = [
  {
    ...
    value: "works",
    apiEndpointFilters:
      "&populate[composers][fields][0]=name&populate[level][fields][1]=title&populate[eras][fields][2]=name&populate[eras][fields][3]=order&populate[works][fields][4]=id&fields[0]=title&filters[works][publishedAt][$null]=false&publicationState=live",
    ...
    cleanFiltersOptions: [
      {
        ...
        apiEndpointFilters:
          "&fields[0]=name&populate[works][fields][1]=id&filters[works][publishedAt][$null]=false&publicationState=live",
      ...
      },
      {
        ...
        apiEndpoint: "levels",
        apiEndpointFilters:
          "&fields[0]=title&populate[works][fields][1]=id&filters[works][publishedAt][$null]=false&publicationState=live",
  ...
  },
  {
    ...
    value: "collections",
    apiEndpointFilters:
      "&populate[eras][fields][0]=name&fields[0]=title&populate[works][fields][1]=id&filters[works][publishedAt][$null]=false&publicationState=live",
  ...
  },
  {
    ...
    col1Width: "300px",
    pageBreakpoint: "100000px",
    textSearchOptions: ["[name]", "[excerpt]"],
  ...
  },
  {
    ...
    value: "elements",
    apiEndpointFilters:
      "&populate[element_categories][fields][0]=name&populate[levels][fields][1]=title&populate[illustration][fields][2]=height&populate[illustration][fields][3]=width&populate[illustration][fields][4]=url&populate[works][fields][5]=id&fields[0]=name&fields[1]=nameAlt&fields[2]=description&filters[publishedAt][$notNull]=true&publicationState=live",
    ...
    cleanFiltersOptions: [
      {
        ...
        apiEndpoint: "element-categories",
        apiEndpointFilters:
          "&fields[0]=name&populate[elements][fields][1]=id&filters[elements][publishedAt][$null]=false&publicationState=live",
      ...
      },
      {
        ...
        apiEndpoint: "levels",
        apiEndpointFilters:
          "&fields[0]=title&populate[elements][fields][1]=id&filters[elements][publishedAt][$null]=false&publicationState=live",
        apiEndpointPageSize: 7, // Updated 2025-05-17
        apiTitleOrName: "title",
        apiSort: "id:asc",
      },
