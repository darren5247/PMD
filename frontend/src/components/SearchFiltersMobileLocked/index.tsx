          ...
          <div
            ...
            <div className='flex flex-col justify-center items-center mt-24'>
              ...
              <div className='justify-center items-center gap-2 grid grid-cols-2 mb-8 align-middle'>
                ...
                <Chip title='Element' className='bg-gradient-to-b from-white to-pmdGrayLight shadow-md shadow-pmdRed border border-pmdRed font-medium' />
                <Chip title='Composer' className='bg-gradient-to-b from-white to-pmdGrayLight shadow-md shadow-pmdRed border border-pmdRed font-medium' />
                ...
                <Chip title='Mood' className='bg-gradient-to-b from-white to-pmdGrayLight shadow-md shadow-pmdRed border border-pmdRed font-medium' />
                <Chip title='Style' className='bg-gradient-to-b from-white to-pmdGrayLight shadow-md shadow-pmdRed border border-pmdRed font-medium' />
                <Chip title='Theme' className='bg-gradient-to-b from-white to-pmdGrayLight shadow-md shadow-pmdRed border border-pmdRed font-medium' />
                <Chip title='and more...' className='bg-gradient-to-b from-white to-pmdGrayLight shadow-md shadow-pmdRed border border-pmdRed font-medium' />
              </div>
