...
const CookieBanner: FC = () => {
  ...
  return (
    <div
      id="cookieConsent"
      className="right-0 bottom-0 left-0 z-50 fixed bg-white shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]"
    >
      <div className="mx-auto p-5 max-w-7xl">
        <div className="flex min-[737px]:flex-row flex-col justify-between items-start min-[737px]:items-center gap-4">
          <div className="flex-1">
            <h2 className="mb-2 font-semibold text-pmdGrayDark text-lg">
              Cookie Preferences
            </h2>
          ...
          <div className="mt-6 pt-6 border-pmdGrayLight border-t">
            <div className="flex flex-col gap-3 max-h-[310px] overflow-y-auto">
              <div className="flex justify-between items-start gap-8 bg-pmdGrayLight p-4 rounded-lg">
                <div className="flex-1">
                  <h3 className="font-semibold text-pmdGrayDark">
                    Necessary Cookies
                  </h3>
                  <p className="mt-1 text-pmdGrayDark text-sm">
                    Essential cookies for necessary website functionality and
                    uninterrupted sessions/form entry.
                  </p>
                </div>
              ...
              <div className="flex justify-between items-start gap-8 bg-pmdGrayLight p-4 rounded-lg">
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-pmdGrayDark text-sm">
                    Help us improve our website by understanding visitor
                    interactions.
                  </p>
                </div>
                <div className="flex items-center h-6">
              ...
              <div className="flex justify-between items-start gap-8 bg-pmdGrayLight p-4 rounded-lg">
                <div className="flex-1">
                  ...
                  <p className="mt-1 text-pmdGrayDark text-sm">
                    Used to show relevant and personalized advertisements.
                  </p>
                </div>
                <div className="flex items-center h-6">
                  <input
