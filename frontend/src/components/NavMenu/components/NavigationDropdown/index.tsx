...
import { IconUserProfileOutlinedRed, IconLoginRed, IconCoin, IconCheckRed, IconHeart, IconBookmark } from '@src/common/assets/icons';
    ...
    >
      <div className='flex flex-row'>
        <div className='flex flex-col border-r'>
          <p className='bg-pmdGrayBright px-3 max-sm:px-2 pt-3 pb-1 border-b'><strong>Links</strong></p>
        ...
        <div className='flex flex-col'>
          <p className='bg-pmdGrayBright px-3 max-sm:px-2 pt-3 pb-1 border-b'><strong>Account</strong></p>
          {name && (
