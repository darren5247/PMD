...
export const GetElement: FC<IGetElementProps> = ({
  elementId,
}): JSX.Element => {
    ...
    <>
      {!isLoadingElements && elements && elements.length > 0 && (
        <CardElement
          ...
          illustrationWidth={
            elements[0].attributes.illustration.data.attributes.width
          }
          illustrationHeight={
            elements[0].attributes.illustration.data.attributes.height
          }
          illustrationURL={
            elements[0].attributes.illustration.data.attributes.url
          }
          id={elements[0].id}
          hideLabel={true}
        />
