...
interface IModalResetAddPublisherFormProps {
  handleClear: () => void;
  isOpen: boolean;
  onClose: () => void;
};

const ModalResetAddPublisherForm: FC<IModalResetAddPublisherFormProps> = ({
  handleClear,
  isOpen,
  onClose
}): JSX.Element => {
    ...
    >
      ...
      <div className='px-4 pt-3 pb-5 border-pmdGrayLight border-t max-h-[500px] overflow-auto text-pmdGrayDark scrollbar'>
        ...
        <p className='mt-4 mb-2'>
          <strong>This new publisher will be lost!</strong>
        </p>
        <p className='my-4'>
        ...
        <div className='flex'>
          <a
            title='Reset Add a Publisher Form'
...
export default ModalResetAddPublisherForm;
