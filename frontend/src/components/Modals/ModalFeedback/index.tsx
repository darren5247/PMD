...
const ModalFeedback: FC<IModalFeedbackProps> = ({
    ...
    const { control, handleSubmit, formState, setValue, watch } = useForm<TAddFeedbackForm>();
    ...
    const handleAddFeedback: SubmitHandler<TAddFeedbackForm> = ({ feedbackText, feedbackEmail }) => {
        if (!handleError({
            feedbackText,
            feedbackEmail
        })) {
    ...
    return (
        ...
        >
            <div className='flex gap-2 py-4 pr-12 pl-5'>
                ...
                <p className='pt-1 text-pmdGrayDark'><strong>Feedback</strong></p>
            </div>
            <div className='px-[20px] pt-4 pb-8 border-pmdGrayLight border-t max-h-screen overflow-auto scrollbar'>
                <div className='flex flex-col gap-3 mt-3 mb-6 text-pmdGrayDark'>
                    ...
                    <p>Feedback is sent to PMD staff for review. The staff will use the URL and your feedback to fix issues, add missing content, etc.</p>
                ...
                <Form className='flex flex-col'>
                    ...
                    <p className='my-6 text-pmdGray text-sm'><em>By sending feedback to Piano Music Database, you agree to the <Link href={`/${EUrlsPages.TERMS_AND_CONDITIONS}`}><a className='text-pmdGray' title='Terms and Conditions'>terms and conditions</a></Link>.</em></p>
                    <div className='mt-2'>
                        <a
                            title='Send Feedback'
