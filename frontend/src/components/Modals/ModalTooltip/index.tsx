    ...
    >
      <div className="flex gap-2 py-4 pr-12 pl-5">
        ...
        <p className="pt-1 text-pmdGrayDark">
          <strong>{tooltip.attributes.tooltipTitle}</strong>
        </p>
      </div>
      <div className="px-4 pt-4 pb-2 border-pmdGrayLight border-t max-h-[500px] overflow-auto text-pmdGrayDark scrollbar">
        <div
          className="text-pmdGrayDark text-sm leading-[20px] whitespace-pre-line"
          dangerouslySetInnerHTML={{ __html: tooltip.attributes.tooltipText }}
        ></div>
      </div>
    </Modal>
  );
