...
interface IModalResetAddCollectionFormProps {
  handleClear: () => void;
  isOpen: boolean;
  onClose: () => void;
};

const ModalResetAddCollectionForm: FC<IModalResetAddCollectionFormProps> = ({
  handleClear,
  isOpen,
  onClose
}): JSX.Element => {
  return (
    <Modal
      id='modalResetAddCollectionForm'
      onClose={onClose}
      isOpen={isOpen}
    ...
    >
      <div className='flex gap-2 py-4 pr-12 pl-5'>
        ...
        <p className='pt-1 text-pmdGrayDark'><strong>Reset Form</strong></p>
      </div>
      <div className='px-4 pt-3 pb-5 border-pmdGrayLight border-t max-h-[500px] overflow-auto text-pmdGrayDark scrollbar'>
        <p>
          Clicking <strong>Reset</strong> below will clear all fields/selections in this form.
        </p>
        <p className='mt-4 mb-2'>
          <strong>This new collection will be lost!</strong>
        </p>
        <p className='my-4'>
        ...
        <div className='flex'>
          <a
            title='Reset Add a Collection Form'
...
export default ModalResetAddCollectionForm;
