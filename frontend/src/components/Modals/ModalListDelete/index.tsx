        ...
        if (listId !== null) {
            try {
                ...
                if (data !== null && data !== undefined) {
                    ...
                    setTimeout(() => {
                        router.push(`/${EUrlsPages.LISTS_CREATED}`, undefined, { shallow: false });
                    }, 500);
                } else {
                    dispatch({
                        type: ENotificationActionTypes.SET_MESSAGE,
    ...
    return (
        ...
        >
            <div className='flex gap-2 py-4 pr-12 pl-5'>
                <ImageNext src={IconDelete} height={22} width={22} className='min-w-[22px] min-h-[22px]' />
                <p className='pt-1 text-pmdGrayDark'><strong>Delete List?</strong></p>
            </div>
                        ...
                        <div className='min-[410px]:min-w-60 max-w-60 text-center'>
                            <h3
                                className={cn(
                                    ...
                                    { 'break-all': listTitle.split(' ').some(word => word.length > 8) }
                                )}
                            >
