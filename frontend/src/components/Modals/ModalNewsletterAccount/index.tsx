...
const ModalNewsletterAccount: FC<IModalNewsletterAccountProps> = ({ isOpen, onClose }): JSX.Element => {
  ...
  return (
    ...
    >
      <div className='flex gap-2 py-4 pr-12 pl-5'>
        <ImageNext src={IconEmailRed} height={22} width={22} className='min-w-[22px] min-h-[22px]' />
        <p className='pt-1 text-pmdGrayDark'><strong>Communication Preferences</strong></p>
      </div>
      <div className='px-4 pt-2 pb-8 border-pmdGrayLight border-t max-h-screen overflow-auto scrollbar'>
        <div className='flex flex-col gap-8 mt-6 w-full'>
          <div className='flex flex-col'>
            ...
            <p className='text-pmdGray text-xs'><em>You may receive direct emails which include important updates to your account and responses to feedback and support requests.</em></p>
          </div>
          <div className='flex flex-col'>
            <a title='Marketing Contact (Optional)' className='flex gap-2.5 no-underline'>
              <Checkbox
            ...
            <p className='mt-1.5 text-pmdGray text-xs'><em>Sign up for our free email newsletter to receive updates from us about upcoming features, new music, deep dives into piano teaching, and more.</em></p>
          </div>
        </div>
      </div>
    </Modal>
