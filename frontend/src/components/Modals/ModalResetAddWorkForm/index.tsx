...
interface IModalResetAddWorkFormProps {
  handleClear: () => void;
  isOpen: boolean;
  onClose: () => void;
};

const ModalResetAddWorkForm: FC<IModalResetAddWorkFormProps> = ({
  handleClear,
  isOpen,
  onClose
}): JSX.Element => {
    ...
    >
      ...
      <div className='px-4 pt-3 pb-5 border-pmdGrayLight border-t max-h-[500px] overflow-auto text-pmdGrayDark scrollbar'>
        ...
        <p className='mt-4 mb-2'>
          <strong>This new work will be lost!</strong>
        </p>
        <p className='my-4'>
...
export default ModalResetAddWorkForm;
