...
const ModalListAddTo: FC<IModalListAddToProps> = ({
  ...
  const [currentPage, setCurrentPage] = useState(
    Number(query.pageLists) && Number(query.pageLists) > 0
      ? Number(query.pageLists)
      : 1,
  );
    ...
    >
      <div className="flex justify-start items-center gap-3 py-4 pr-12 pl-5 w-full text-left align-middle">
        ...
        <p className="mr-4 text-pmdGrayDark">
          <strong>Add to Your Lists</strong>
        </p>
      </div>
      <div className="pt-6 border-pmdGrayLight border-t max-h-screen overflow-y-auto scrollbar">
        <div className="flex flex-col justify-center items-center gap-4 w-full text-center align-middle">
          <p className="px-3 text-center">Piece being added to your lists:</p>
          <p className="px-3 font-medium text-lg text-center">{workTitle}</p>
          <Divider />
          <div
            id="lists-list"
            className="flex flex-col flex-wrap justify-center items-center w-full max-w-[1100px]"
          >
            {isLoadingLists ? (
              ...
              <section
                id="yourLists"
                className="flex flex-col justify-center items-center gap-2 mx-auto text-center align-middle"
              >
                <h3 id="your-lists" className="px-3">
                  Your Lists
                </h3>
