    ...
    >
      ...
      <div className="border-pmdGrayLight border-t max-h-[500px] overflow-auto scrollbar">
        <div className="flex flex-row flex-wrap justify-center gap-x-4 gap-y-4 mt-4 mb-4 px-3">
          <Link
            href={`https://facebook.com/sharer/sharer.php?u=${urlEncoded}&quote=${textEncoded}%20-%20${urlEncoded}`}
          >
            <a
          ...
          <Link
            href={`https://x.com/intent/tweet?text=${textEncoded}&url=${urlEncoded}`}
          >
            <a
              className="hover:opacity-70 p-1 transition-all"
          ...
          <Link
            href={`https://linkedin.com/sharing/share-offsite/?url=${urlEncoded}`}
          >
            <a
              className="hover:opacity-70 p-1 transition-all"
          ...
          <Link href={`https://reddit.com/submit?url=${urlEncoded}`}>
            <a
              className="hover:opacity-70 p-1 transition-all"
          ...
          <Link href={`https://wa.me/?text=${textEncoded}%20-%20${urlEncoded}`}>
            <a
              className="hover:opacity-70 p-1 transition-all"
          ...
          <Link
            href={`https://pinterest.com/pin/create/link/?url=${urlEncoded}`}
          >
            <a
              className="hover:opacity-70 p-1 transition-all"
          ...
          <Link
            href={`mailto:?subject=${textEncoded}&body=${textEncoded}%0D%0A${urlEncoded}`}
          >
            <a
              className="hover:opacity-70 p-1 transition-all"
