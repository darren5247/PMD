...
const TableItem: FC<ITableItemProps> = ({ label, items, col1Label, col2Label, col3Label, col4Label, col1Width, col2Width, col3Width, col4Width, pageBreakpoint }): JSX.Element => {
            ...
            <div key='worksTableHeadingRowTop' id='worksTableHeadingRowTop' className='flex flex-row justify-end bg-pmdGrayDark px-4 py-3 rounded-t-md w-full !text-white text-left'>
              <div className='flex flex-row flex-1 gap-4 text-sm align-middle tracking-normal'>
                <div
                  className={cn(
                    'w-full',
                    col1Width ? `min-w-[${col1Width}] max-w-[${col1Width}]` : 'min-w-[230px]'
                  )}
                >
                ...
                {col2Label ? (
                  <div
                    className={cn(
                      col2Width ? `min-w-[${col2Width}] max-w-[${col2Width}]` : 'min-w-[165px] max-w-[165px]'
                    )}
                  >
                ...
                {col3Label ? (
                  <div
                    className={cn(
                      col3Width ? `min-w-[${col3Width}] max-w-[${col3Width}]` : 'min-w-[110px] max-w-[110px]'
                    )}
                  >
                ...
                {col4Label ? (
                  <div
                    className={cn(
                      col4Width ? `min-w-[${col4Width}] max-w-[${col4Width}]` : 'min-w-[100px] max-w-[100px]'
                    )}
                  >
