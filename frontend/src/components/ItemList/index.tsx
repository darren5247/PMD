...
const ItemList: FC<IItemList> = ({ index, list }): JSX.Element => {
  return (
    <div
      key={index ? index : 0}
      className="flex flex-row justify-center items-center gap-2 text-center align-middle"
    >
      <Link
        href={
          "/" +
      ...
      >
        <a
          ...
          className="flex flex-col items-center bg-white hover:bg-pmdGrayBright shadow-header p-4 border border-pmdGrayBright rounded-md h-fill no-underline transition-all cursor-pointer grow"
        >
