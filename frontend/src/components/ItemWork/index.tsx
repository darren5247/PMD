...
// import { ModalEdit } from '@src/components/Modals';
...
import { ModalListAddTo } from "@src/components/Modals";
...
export const ItemWork: FC<IItemWorkProps> = ({ musicWork }): JSX.Element => {
  ...
  const handleIsOpenModalListAddTo = () =>
    setIsOpenModalListAddTo(!isOpenModalListAddTo);
    ...
    const getFavorites = async () => {
      try {
        ...
        if (data !== null || data !== undefined || data?.data.length > 0) {
          ...
          const newIsFavorite =
            data?.data.length > 0 && data?.data[0].id ? true : false;
      ...
      try {
        ...
        if (
          ...
          dispatch({
            ...
            payload: {
              message: musicWork?.attributes.title
                ? `Favorite Added: ${musicWork?.attributes.title.trim()}`
                : `Favorite Added`,
    ...
    if (userId !== null && id !== null) {
      try {
        ...
        dispatch({
          ...
          payload: {
            message: musicWork?.attributes.title
              ? `Favorite Removed: ${musicWork?.attributes.title.trim()}`
              : `Favorite Removed`,
            type: ENotificationTypes.SUCCESS,
          },
        });
  ...
  if (musicWork && musicWork.attributes.title) {
    ...
    workTitleEncoded =
      encodeURIComponent(handleTitleWithJustNumber(titleSaved)) +
      "-" +
      encodeURIComponent(handleTitleWithJustNumber(workComposers));
  ...
  return (
    <>
      {musicWork && (
        <article
          id={`${musicWork.id}`}
          className="flex flex-col justify-center items-center gap-y-3 text-center"
        >
            ...
            <section id="review" className="flex justify-center">
              <div className="bg-orange-500 shadow-workNav mx-4 mb-12 py-4 rounded-lg">
                ...
                <p className="px-4 text-white text-center tracking-thigh">
                  <strong>
                    This work is currently <em>under review</em> by staff.
                  </strong>
                </p>
                <p className="mt-4 px-4 text-white text-center tracking-thigh">
                  <strong>
                    This page is publicly viewable while under review, but the
                    work will not appear in PMD search results.
                  </strong>
                </p>
                <p className="mt-4 px-4 text-white text-center tracking-thigh">
                  <strong>
                    Also, some data may not be viewable on this page while under
                    review.
                  </strong>
                </p>
                <p className="px-4 text-white text-center tracking-thigh">
                  <strong>
                    This includes related collections, composers, and publishers
              ...
              <div className="flex min-[935px]:flex-row flex-col justify-center items-top max-[935px]:items-center gap-x-6 gap-y-8 text-center">
                {musicWork.attributes.image?.data ? (
                  <div className="min-[935px]:mt-5 min-w-auto sm:min-w-[300px] max-w-[240px] sm:max-w-[300px]">
                    <ImagePicture
                      alt={
                        musicWork.attributes.image?.data?.attributes
                          .alternativeText
                          ? musicWork.attributes.image?.data?.attributes
                              .alternativeText
                      ...
                      src={
                        musicWork.attributes.image?.data?.attributes.url
                          ? musicWork.attributes.image?.data?.attributes.url
                          : ""
                      }
                      height={
                        musicWork.attributes.image?.data?.attributes.height
                          ? musicWork.attributes.image?.data?.attributes.height
                          : 0
                      }
                      width={
                        musicWork.attributes.image?.data?.attributes.width
                          ? musicWork.attributes.image?.data?.attributes.width
                          : 0
                      }
                    />
                ...
                >
                  {musicWork.attributes.title ? (
                    <div
                      className={cn(
                        ...
                        {
                          "pb-2 max-w-[700px] max-[615px]:text-center":
                            !musicWork.attributes.image?.data,
                        },
                      )}
                    >
                  ...
                  >
                    {musicWork.attributes.composers?.data?.length ? (
                      ...
                      >
                        {musicWork.attributes.composers.data.map(
                          (composer, composerIndex) => (
                            ...
                            >
                              ...
                              {musicWork.attributes.composers.data &&
                                composerIndex <
                                  musicWork.attributes.composers.data.length -
                                    1 &&
                                ", "}
          ...
          {(musicWork.attributes.scoreExcerpt.data?.attributes.formats?.large
            ?.url ??
              ...
              <div className="w-full max-md:w-[calc(76vw-16px)] max-w-screen max-md:overflow-x-auto">
                <div className="min-w-[707px] max-w-[707px] min-h-[164px] max-h-[164px]">
                  <ImagePicture
                    ...
                    src={
                      musicWork.attributes.scoreExcerpt.data?.attributes.formats
                        ?.large?.url ??
                      musicWork.attributes.scoreExcerpt.data?.attributes.url
                    }
                    height={164}
            ...
            <div className="flex flex-wrap justify-center items-center gap-4 mb-8 w-full h-full align-middle">
              {isLoadingFavorites ? (
                ...
                <a
                  title={
                    musicWork?.attributes.title
                      ? "Unfavorite " + musicWork?.attributes.title
                      : "Unfavorite"
                  }
                  onClick={() => {
                    isSubmitFavoriteAllowed == true &&
                ...
                <a
                  title={
                    musicWork?.attributes.title
                      ? "Favorite " + musicWork?.attributes.title
                      : "Favorite"
                  }
                  onClick={() => {
                    isSubmitFavoriteAllowed == true &&
          ...
          <section id="overview" className="mx-auto mb-14 px-4 max-w-[707px]">
            {musicWork.attributes.sheetMusicLinks?.length ? (
              <div
                id="get"
                className="flex md:flex-row flex-col justify-left items-left mt-4 text-left"
              >
                ...
                {musicWork.attributes.sheetMusicLinks?.length ? (
                  <div className="flex flex-row flex-wrap justify-left items-left gap-2 mt-2 mb-5 text-left">
                    {musicWork.attributes.sheetMusicLinks.map(
                      (sheetMusicLink) => (
                        <BuyLink
                          key={
                            sheetMusicLink.url
                              ? sheetMusicLink.url
                              : sheetMusicLink.sellerName
                          }
                          sellerName={sheetMusicLink.sellerName}
                          itemName={`Get ${musicWork.attributes.title}`}
                          url={sheetMusicLink.url}
                          linkText={sheetMusicLink.linkText}
                          sellerImage={
                            sheetMusicLink.sellerImage.data?.attributes.url
                          }
                          sellerImageHeight={
                            sheetMusicLink.sellerImage.data?.attributes.height
                          }
                          sellerImageWidth={
                            sheetMusicLink.sellerImage.data?.attributes.width
                          }
                        />
                      ),
                    )}
                      ...
                      <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                        ...
                        <div className="flex flex-col w-full h-full">
                          <div className="flex gap-2">
                            <Link
                              key={collection.attributes.title}
                              href={`/${EUrlsPages.COLLECTION}/${collection.attributes.title}?id=${collection.id}`}
                            >
                              <a
                                className="text-base"
                                title={`View ${collection.attributes.title}`}
                              >
                          ...
                          {collection.attributes?.purchase_link?.length ? (
                            <div className="flex flex-row flex-wrap gap-2 mt-2 mb-5">
                              {collection.attributes?.purchase_link?.map(
                                (sheetMusicLink) => (
                                  <div
                                    key={
                                      sheetMusicLink.url
                                  ...
                                  >
                                    <BuyLink
                                      sellerName={sheetMusicLink.sellerName}
                                      itemName={`Get ${collection.attributes.title} which includes ${musicWork.attributes.title}`}
                                      url={sheetMusicLink.url}
                                      linkText={sheetMusicLink.linkText}
                                      sellerImage={
                                        sheetMusicLink.sellerImage.data
                                          ?.attributes.url
                                      }
                                      sellerImageHeight={
                                        sheetMusicLink.sellerImage.data
                    ...
                    <div className="flex flex-row flex-wrap justify-center items-center gap-x-2 gap-y-1 shadow-musicCard p-1 rounded-lg text-center">
                      <Link href={musicWork.attributes.urlSpotify}>
                        <a
                          ...
                          title={`Listen to ${workTitleDisplay} on Spotify`}
                          target="_blank"
                  ...
                  {musicWork.attributes.urlAppleMusic && (
                    <div className="flex flex-row flex-wrap justify-center items-center gap-x-2 gap-y-1 shadow-musicCard p-1 rounded-lg text-center">
                      <Link href={musicWork.attributes.urlAppleMusic}>
                        <a
                          className="group flex justify-center items-center text-center"
                          title={`Listen to ${workTitleDisplay} on Apple Music`}
                          target="_blank"
                          rel="noopener noreferrer"
                        >
                          <ImageNext
            ...
            {musicWork.attributes.eras.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.eras.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                      <strong>Eras</strong>
                    </p>
                  ) : (
                    <p className="min-w-[175px] text-left">
            ...
            {musicWork.attributes.moods.data?.length ? (
              <div
                ...
                className="flex md:flex-row flex-col justify-left items-left mt-4 text-left"
              >
                {musicWork.attributes.moods.data?.length > 1 ? (
                  <p className="min-w-[175px] text-left">
                    <strong>Moods</strong>
                  </p>
                ) : (
            ...
            {musicWork.attributes.styles.data?.length ? (
              <div
                ...
                className="flex md:flex-row flex-col justify-left items-left mt-4 text-left"
              >
                {musicWork.attributes.styles.data?.length > 1 ? (
                  <p className="min-w-[175px] text-left">
                ...
                <div className="flex flex-wrap gap-2">
                  {musicWork.attributes.styles.data?.map(
                    (style, styleIndex) => (
            ...
            {musicWork.attributes.themes.data?.length ? (
              <div
                ...
                className="flex md:flex-row flex-col justify-left items-left mt-4 text-left"
              >
                {musicWork.attributes.themes.data?.length > 1 ? (
                  <p className="min-w-[175px] text-left">
                ...
                <div className="flex flex-wrap gap-2">
                  {musicWork.attributes.themes.data?.map(
                    (theme, themeIndex) => (
          ...
          */}
          {cookieConsent && preferences.marketing && (
            <div className="my-4">
              <AdsenseAd
          ...
          {musicWork.attributes.videoEmbedCode && (
            <>
              ...
              <div id="video" className="mx-auto mb-14 w-full md:max-w-[816px]">
                <VideoPlayer
                  videoURL={musicWork.attributes.videoEmbedCode}
                  videoName={musicWork.attributes.title}
                />
              </div>
            </>
          )}
          ...
          {musicWork.attributes.elements.data?.length ? (
            <WorkElements
              elements={musicWork.attributes.elements.data}
              published={
                musicWork.attributes.publishedAt !== null ? true : false
              }
            />
          ) : (
            ""
          ...
          <section id="details" className="mx-auto px-4 md:max-w-[707px]">
            ...
            {musicWork.attributes.composers.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.composers.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
            ...
            {musicWork.attributes.publishers.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.publishers.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {musicWork.attributes.publishers.data?.map(
                      (publisher, publisherIndex) => (
                        ...
                        >
                          ...
                          {musicWork.attributes.publishers.data &&
                            publisherIndex <
                              musicWork.attributes.publishers.data.length - 1 &&
                            ", "}
                        </span>
            ...
            {musicWork.attributes.collections.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.collections.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {musicWork.attributes.collections.data?.map(
                      (collection, collectionIndex) => (
                        <span
                          className="text-base"
                          key={`${collection.attributes.title}-${collectionIndex}`}
                        >
                          <Link
                            href={`/${EUrlsPages.COLLECTION}/${collection.attributes.title}?id=${collection.id}`}
                          >
                          ...
                          {musicWork.attributes.collections.data &&
                            collectionIndex <
                              musicWork.attributes.collections.data.length -
                                1 &&
                            ", "}
            ...
            {musicWork.attributes.instrumentations.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.instrumentations.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                      <strong>Instrumentations</strong>
                    </p>
                  ) : (
                    <p className="min-w-[175px] text-left">
                  ...
                  <div className="flex flex-wrap">
                    {musicWork.attributes.instrumentations.data?.map(
                      (instrumentation, instrumentationIndex) => (
                      ...
                      ><span className='inline'>{instrumentation.attributes.name}</span></a></Link> */}
                          <span className="inline">
                            {instrumentation.attributes.name}
                          </span>
                          {musicWork.attributes.instrumentations.data
                            ?.length ? (
            ...
            {musicWork.attributes.keySignatures.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.keySignatures.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                  ...
                  <div className="flex flex-wrap">
                    {musicWork.attributes.keySignatures.data?.map(
                      (keySignature, keySignatureIndex) => (
            ...
            {musicWork.attributes.timeSignatures.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.timeSignatures.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                  ...
                  <div className="flex flex-wrap">
                    {musicWork.attributes.timeSignatures.data?.map(
                      (timeSignature, timeSignatureIndex) => (
                      ...
                      ><span className='inline'>{timeSignature.attributes.title}</span></a></Link> */}
                          <span className="inline">
                            {timeSignature.attributes.title}
                          </span>
                          {musicWork.attributes.timeSignatures.data?.length ? (
                            timeSignatureIndex <
                            musicWork.attributes.timeSignatures.data?.length -
            ...
            {musicWork.attributes.hasTeacherDuet?.toString() && (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  <p className="min-w-[175px] text-left">
                    <strong>Teacher Duet</strong>
                  </p>
                  <div className="flex">
                    <p>
                      {musicWork.attributes.hasTeacherDuet.toString() == "true"
                        ? "Yes"
                        : "No"}
                    </p>
                  </div>
            ...
            {musicWork.attributes.hasLyrics?.toString() && (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  ...
                  <div className="flex gap-2 max-w-[175px] overflow-auto">
                    <p>
                      {musicWork.attributes.hasLyrics.toString() == "true"
                        ? "Yes"
                        : "No"}
                    </p>
                  </div>
            ...
            {musicWork.attributes.holidays.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.holidays.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                  ...
                  <div className="flex flex-wrap">
                    {musicWork.attributes.holidays.data?.map(
            ...
            {musicWork.attributes.studentAges.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.studentAges.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                      <strong>Student Ages</strong>
                    </p>
                  ) : (
                    <p className="min-w-[175px] text-left">
                  ...
                  <div className="flex flex-wrap">
                    {musicWork.attributes.studentAges.data?.map(
                      (studentAge, studentAgeIndex) => (
            ...
            {musicWork.attributes.studentTypes.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.studentTypes.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                  ...
                  <div className="flex flex-wrap">
                    {musicWork.attributes.studentTypes.data?.map(
                      (studentType, studentTypeIndex) => (
            ...
            {musicWork.attributes.teachingTips.data?.length ? (
              <>
                <div className="flex md:flex-row flex-col justify-left items-left mt-4 text-left">
                  {musicWork.attributes.teachingTips.data?.length > 1 ? (
                    <p className="min-w-[175px] text-left">
                  ...
                  <div className="flex flex-col gap-2 max-w-[175px] overflow-auto text-left">
                    {musicWork.attributes.teachingTips.data?.map(
                      (teachingTip, teachingTipIndex) => (
                        <p key={teachingTip.attributes.title}>
                          {teachingTip.attributes.title}
                          {musicWork.attributes.teachingTips.data?.length ? (
                            teachingTipIndex <
                            musicWork.attributes.teachingTips.data?.length -
                              1 ? (
