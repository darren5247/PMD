...
const RequestPasswordPage: NextPage<IRequestPasswordPageProps> = ({ prevUrl }) => {
        ...
        <Form onSubmit={handleSubmit(handleReset)}>
          ...
          <p className='mb-8 pr-3 text-pmdGrayDark text-sm text-end'>
            <Link href={`/${EUrlsPages.FORGOT_EMAIL}`}>
              <a title='Forgot Email?'>
                Forgot Email?
              </a>
            </Link>
          </p>
          <div className='flex items-center mb-12 text-center'>
            <button title='Request Password Reset' className='mx-auto !px-[54px] button' type='submit'>Request Password Reset</button>
          </div>
