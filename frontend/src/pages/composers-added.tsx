...
const ComposersAddedPage: NextPage<IComposersAddedPageProps> = ({
  prevUrl,
}) => {
  ...
  return (
    ...
    >
      <div className="max-w-[460px] text-center">
        <h1 className="mx-auto">Composers Added</h1>
        <>
          {isLoadingComposers ? (
            ...
            <div>
              ...
              {composers.map((composer) => (
                ...
                >
                  <div className="flex flex-col gap-4 text-left">
                    ...
                    <Link
                      href={`/${EUrlsPages.COMPOSER}/${encodeURIComponent(composer.attributes.name)}?id=${composer.id}`}
                    >
                      <a
                        title={`View composer #${composer.id}`}
                  ...
                  <div className="flex flex-col gap-2 text-left">
                    <div className="flex flex-row gap-4 pb-2 border-pmdGray border-b text-left">
                      <p>
                        <em>{composer.attributes.name}</em>
                      </p>
                    </div>
                    <div className="flex flex-row gap-4 text-left">
                      <p>
                        Created{" "}
                        {composer.attributes.createdAt
                          .replace("T", " at ")
                          .replace("Z", " GMT")}
                      </p>
                    </div>
                    ...
                    {composer.attributes.publishedAt ? (
                      ...
                      composer.attributes.adminReview == "Complete" ? (
                        ...
                        <div className="flex flex-col text-left">
                          <p>Under Review</p>
                          <p>
                            Review Status: {composer.attributes.adminReview}
                          </p>
                        </div>
                      )
                    ) : (
              ...
              {composers.length > 9 && (
                <div className="flex justify-center items-center gap-3 min-[340px]:gap-5 mt-6 mb-3 text-sm">
                  <Link
                    href={EUrlsPages.COMPOSERS_ADDED + "?page=1#worksAdded"}
                  >
                    <a
                      title="First Page"
                      className={cn(
