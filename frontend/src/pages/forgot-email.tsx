    ...
    >
      <div className="flex flex-col mx-auto max-w-[340px]">
        ...
        <p className="mt-4 mb-2 text-pmdGrayDark text-sm">
          Contact us and provide relevant information and we may be able to
          connect you with the email on your account.
        </p>
        <p className="mt-4 mb-2 text-pmdGrayDark text-sm">
          <a
            className="cursor-pointer button"
            title="Email Piano Music Database using Contact@PianoMusicDatabase.com"
            onClick={() => {
        ...
        <p className="mt-4 mb-2 text-pmdGrayDark text-sm">
          Or, send an email to{" "}
          <Link href="mailto:Contact@PianoMusicDatabase.com?subject=Forgot Email for Piano Music Database Account">
            <a
