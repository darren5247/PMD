...
const AccountDashboardPage: NextPage<IAccountDashboardPageProps> = ({
  prevUrl,
}) => {
  const siteUrl =
  ...
  return (
    <Page
      ...
      classNameMain="!max-w-full !mx-0 !px-0 !mb-0"
    >
      <h1 className="text-center">Account Dashboard</h1>
      <section
        id="account-settings"
        className="flex flex-col items-center gap-y-4 px-3"
      >
        <div className="flex flex-col items-center gap-y-3 mt-4">
          ...
          {userType && <Chip title={"Type: " + userType} />}
          {userOccupation && (
            <Chip title={"Occupation(s): " + userOccupation} />
          )}
        </div>
        <div className="flex flex-wrap justify-center items-center gap-3 mt-4">
          <Link href={`/${EUrlsPages.FAVORITES}`}>
            <a title="Your Favorites">
              <div className="flex flex-col items-center bg-white hover:bg-pmdGrayBright shadow-header p-2 rounded-lg w-48 h-36 transition-all cursor-pointer">
          ...
          <Link href={`/${EUrlsPages.LISTS_CREATED}`}>
            <a title="Your Lists">
              <div className="flex flex-col items-center bg-white hover:bg-pmdGrayBright shadow-header p-2 rounded-lg w-48 h-36 transition-all cursor-pointer">
                <div className="flex flex-col items-center gap-y-4 my-auto">
          ...
          <Link href={`/${EUrlsPages.ACCOUNT_SETTINGS}`}>
            <a title="Edit Your Account Details">
              <div className="flex flex-col items-center bg-white hover:bg-pmdGrayBright shadow-header p-2 rounded-lg w-48 h-36 transition-all cursor-pointer">
                <div className="flex flex-col items-center gap-y-4 my-auto">
                  <ImageNext
      ...
      <section id="pmdplus" className="flex flex-col mt-12 px-3 max-w-[600px]">
        <h2 id="pmd-plus" className="my-4 text-center">
          PMD Plus
        </h2>
        <div className="flex flex-wrap justify-center items-center gap-3 mt-4">
      ...
      <section
        ...
        className="flex flex-col mt-12 px-3 text-center"
      >
        <h2 id="contributions" className="my-4">
          Contributions
        </h2>
      ...
      <section id="fb-group" className="flex flex-col mt-20 w-full">
        <div className='flex flex-col justify-center items-center bg-[url("/lines.png")] bg-pmdRed bg-cover bg-no-repeat bg-bottom bg-local px-4 py-16 w-full text-white text-center'>
          ...
          <a
            title="Join Now Free"
            href="https://facebook.com/groups/371031046051751"
