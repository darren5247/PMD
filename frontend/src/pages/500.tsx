  ...
  return (
    ...
    >
      <>
        ...
        <h2 className='mt-10'><em>A server-side error occurred.</em></h2>
        <p className='mt-2'>The server encountered an internal error or misconfiguration and was unable to complete your request.</p>
      </>
    </Page>
  );
};
