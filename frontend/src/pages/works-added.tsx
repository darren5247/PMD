      ...
      composers.forEach((composer) => {
        if (!commaSeparatedComposers) {
          ...
          if (composers.length == 2) {
            commaSeparatedComposers =
              commaSeparatedComposers + " and " + composer.attributes.name;
          } else {
            commaSeparatedComposers =
              commaSeparatedComposers + ", " + composer.attributes.name;
          }
  ...
  return (
    ...
    >
      <div className="max-w-[460px] text-center">
        <h1 className="mx-auto">Works Added</h1>
        <>
          {isLoadingWorks ? (
            ...
            <div>
              ...
              {userName && (
                <div
                  id="worksAdded"
                  className="flex flex-row justify-center items-center gap-4 mt-8 mb-4 px-4 align-middle"
                >
                  <p>Works added by:</p>
                  <Chip title={userName} />
                </div>
              ...
              {works.map((work) => (
                ...
                >
                  <div className="flex flex-col gap-4 text-left">
                    ...
                    <Link
                      href={`/${EUrlsPages.WORK}/${encodeURIComponent(work.attributes.title)}-${encodeURIComponent(commaComposers(work.attributes.composers.data))}?id=${work.id}`}
                    >
                      <a
                        title={`View work #${work.id}`}
                  ...
                  <div className="flex flex-col gap-2 text-left">
                    <div className="flex flex-row gap-4 pb-2 border-pmdGray border-b text-left">
                      ...
                      <p>
                        <em>
                          {commaComposers(work.attributes.composers.data)}
                        </em>
                      </p>
                    </div>
              ...
              {works.length > 9 && (
                <div className="flex justify-center items-center gap-3 min-[340px]:gap-5 mt-6 mb-3 text-sm">
                  <Link href={EUrlsPages.WORKS_ADDED + "?page=1#worksAdded"}>
                    <a
                      title="First Page"
                      className={cn(
                        currentPage === 1
