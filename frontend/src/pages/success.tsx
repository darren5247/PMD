...
const PlusSuccessPage: NextPage<IPlusSuccessPageProps> = ({
  prevUrl,
  sessionId,
}) => {
  ...
  useEffect(() => {
    const getSubscriptionDetails = async () => {
      if (!sessionId) {
        setError(
          "We could not process your payment. No session ID was provided. This means we could not verify your payment. Please try again.",
        );
        setLoading(false);
        return;
      }
        ...
        {loading ? (
          ...
          <div>
            ...
            <p className="mb-4 text-lg text-center">
              There was an error during the subscription process: <br />
              <em>{error}</em>
            </p>
          </div>
        ) : subscription ? (
          <div>
            ...
            <p className="mb-2 text-lg text-center">
              We hope you enjoy the powerful features.
            </p>
              ...
              <div className="space-y-3 text-left">
                ...
                <p>
                  <Link href={`/${EUrlsPages.PLAN}`}>
                    <a title="Plan Details" className="cursor-pointer">
                      Plan Details
                    </a>
                  </Link>
                </p>
            ...
            <div className="flex flex-col justify-center items-center gap-6 mb-6">
              <Link href={`/${EUrlsPages.ACCOUNT_DASHBOARD}`}>
                <a title="Account Dashboard" className="cursor-pointer button">
                  Account Dashboard
                </a>
              </Link>
            </div>
          ...
          <div>
            ...
            <p className="mb-4 text-lg text-center">
              No subscription information was found in our database. <br />
              Please{" "}
