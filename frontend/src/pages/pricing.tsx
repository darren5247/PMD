    ...
    >
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col justify-center items-center gap-3 mb-6">
          <p className="max-w-96 text-lg text-center">
            Check out our features and then choose a plan to get started with
            PMD Plus.
          </p>
        </div>
        <div className="flex min-[940px]:flex-row flex-col justify-center items-start gap-12">
            ...
            <table className="min-w-full overflow-hidden text-sm sm:text-base border-separate border-spacing-y-2">
              <thead>
                <tr className="bg-gray-100 border-gray-200 border-b rounded">
                  <th className="py-2 pr-3 sm:pr-6 pl-2 font-semibold text-left">
                    Benefit
                  </th>
                  <th className="sm:px-2 py-2 pl-1 font-semibold text-center whitespace-nowrap">
                    Free
                  </th>
                  <th className="sm:px-2 py-2 pl-1 font-semibold text-center whitespace-nowrap">
                    Plus
              ...
              <tbody>
                {FEATURES.map((feature, idx) =>
                  feature.label === "div" ? (
                    ...
                    >
                      <td className="py-2 pr-3 sm:pr-6 pl-2 w-min sm:w-full max-w-[222px]">
                        {feature.label}
                      </td>
                      <td className="sm:px-2 py-2 pl-1 min-w-[49px] sm:min-w-[78px] text-center">
                        {feature.free ? (
                          <span className="inline-block bg-green-300 px-2 py-1 rounded font-bold text-green-800">
                            ✓
                          </span>
                        ) : (
          ...
          <div className="flex flex-col justify-center items-center gap-4 mt-2 w-full">
            ...
            <div
              id="plan-choice"
              className="flex flex-col justify-center items-stretch gap-4 mx-auto w-full align-middle"
            >
              <div
                id="plan-monthly"
                className="flex min-[465px]:flex-row flex-col justify-center items-center gap-y-8 bg-white shadow-elementCard px-3 py-10 rounded text-center"
              >
                <h3 className="px-4 min-w-[140px] !text-2xl text-left">
