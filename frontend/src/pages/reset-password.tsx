  ...
  const handleCreateNewPassword: SubmitHandler<TResetPasswordForm> = async ({
    ...
    if (!code) {
      dispatch({
        ...
        payload: {
          message: "No Security Code Provided! Open the link in your email.",
  ...
  return (
    ...
    >
      <div className="max-w-[320px]" id="resetpassword">
        <h1 className="mx-auto">Reset Password</h1>
        <p className="mx-auto mt-4 text-pmdGrayDark text-sm">
          Enter the new password for your account. This will replace your
          previous password.
        </p>
